...
import { Box, Button, Typography, Collapse, TextField, MenuItem, Grid } from "@mui/material";
...
export default function SettingsPanel({ contexts, settings, models, modes }) {
  ...
  return (
    <>
      ...
      <Box sx={{ display: "flex", width: "100%", p: 1, bgcolor: "transparent", boxShadow: "none", borderRadius: 0 }}>
          ...
          <>
            {selectedTab === "settings" && (
              <>
                ...
                />
                {settings.length > 0 && (
                  <TextField select fullWidth label="Sélectionner un paramètre" value={selectedValues.settings} onChange={handleChange("settings")}>
            ...
            {selectedTab === "context" && (
              <>
                ...
                />
                {contexts.length > 0 && (
                  <TextField select fullWidth label="Sélectionner un contexte" value={selectedValues.context} onChange={handleChange("context")}>
            ...
            {selectedTab === "models" && (
              <>
                ...
                {models.length > 0 && (
                  <TextField select fullWidth label="Sélectionner un modèle" value={selectedValues.model} onChange={handleChange("model")}>
            ...
            {selectedTab === "mode" && (
              <>
                ...
                {modes.length > 0 && (
                  <TextField select fullWidth label="Sélectionner un mode" value={selectedValues.mode} onChange={handleChange("mode")}>
